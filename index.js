...
// --- CONSTANTS ---
const LABIRINTAR_LOGO_URL = 'IMG_5430.png';
const SEMEEI_LOGO_URL = 'SEMEEI-logo.png';

const imageBase64 = "data:image/jpeg;base64,-";
const axes = [
  {
    title: 'Quintal Vivo',
...
const LabirintarLogo = ({ className }) => {
  return (
    <div className={`flex items-center ${className}`}>
        <img src={LABIRINTAR_LOGO_URL} alt="LABirintar Logo" className="h-12" />
    </div>
  );
};
...
const AccordionItem = ({ axe, isOpen, onClick }) => {
  return (
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="mt-20 max-w-4xl mx-auto">
          ...
          <div className="mt-10 grid gap-8 md:grid-cols-2">
            <div className="bg-[#E6CBE4] p-8 rounded-xl shadow-md">
              <h4 className="font-slab text-xl font-bold text-[#583f55] text-center">Formação para Gestores</h4>
              <p className="mt-2 text-[#3a3a3a] text-center">
            ...
            <div className="bg-[#AEC5E7] p-8 rounded-xl shadow-md">
              <h4 className="font-slab text-xl font-bold text-[#3a4a6e] text-center">Gestão Simplificada com Festpay</h4>
              <p className="mt-2 text-[#3a3a3a] text-center">
                Adesão à <strong>Festpay</strong> com 6 meses de isenção. Modernize a gestão de pagamentos e da cantina escolar com nosso sistema parceiro, oferecendo mais praticidade para as famílias e otimizando a operação.
              </p>
            </div>
          </div>
        </div>
    ...
    <footer className="bg-white border-t border-gray-200">
      <div className="container mx-auto px-6 py-12 text-center text-gray-500">
        <div className="flex flex-col items-center mb-6">
          <div className="flex items-center justify-center gap-x-8 mb-2">
            <LabirintarLogo />
            <img src={SEMEEI_LOGO_URL} alt="SEMEEI Logo" className="h-12"/>
          </div>
          <p className="font-sans text-xs text-[#BF917F]">Lugar de Fazer e Ser</p>
        </div>
